...
const MPContractAddress = "0x92d81acc7b2903293cec0ccbb0b9aaa059db958c";
...
const identiconTemplate = function (_address) {
  const icon = blockies
    .create({
      seed: _address,
      size: 8,
...
const notification = function (_text) {
  document.querySelector(".alert").style.display = "block";
  document.querySelector("#notification").textContent = _text;
};

const notificationOff = function () {
...
const newProdBtn = document.querySelector("#newProductBtn");
